...
const COLORS = ["#22d3ee", "#f472b6", "#34d399", "#a78bfa"];
      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Tooltip
            ...
            cursor={{ stroke: "var(--chart-axis)", strokeWidth: 1, strokeOpacity: 0.4 }}
          />
          <Legend
          ...
          {seriesNames.map((name, i) => (
            <Line
              ...
              dot={
                period === "48h"
                  ? { r: 4, fill: COLORS[i % COLORS.length], strokeWidth: 2, stroke: "rgba(10,10,15,0.9)" }
                  : period === "7d"
                    ? { r: 3, strokeWidth: 2 }
                    : false
              }
